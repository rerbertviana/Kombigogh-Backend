...
class ListProductUserCategoryActiveService {
    ...
    public async execute({ user_id, category_id }: IRequest): Promise< Object | undefined> {
        ...
        const activeproducts =  products.filter(product => product.ativo == true && product.quantidade != 0)
           
        return activeproducts;
    }
}

export default ListProductUserCategoryActiveService;